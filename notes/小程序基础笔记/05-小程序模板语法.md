...
7. 删除对象中的属性
   ...
   删除多个属性（rest是个对象，是去除age和test属性后的数据 对象）：
   
   ![image-20240411162938684](C:\Users\Joseph\AppData\Roaming\Typora\typora-user-images\image-20240411162938684.png)
...
![image-20240411171207275](C:\Users\Joseph\AppData\Roaming\Typora\typora-user-images\image-20240411171207275.png)

​		splice方法详见：https://www.runoob.com/jsref/jsref-splice.html
...
列表渲染：就是指通过循环遍历一个**数组或对象**，将其中的每个元素渲染到页面上
